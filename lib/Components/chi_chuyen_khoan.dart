...
List<String> listTaiKhoanChi = taiKhoanChi;

class ChiChuyenKhoan extends StatefulWidget {
  const ChiChuyenKhoan({super.key});

  @override
  State<ChiChuyenKhoan> createState() => _ChiChuyenKhoanState();
}

class _ChiChuyenKhoanState extends State<ChiChuyenKhoan> {
  ...
  void uploadData() async {
    if (filesUrlList.isNotEmpty) {
      CollectionReference productRef =
          FirebaseFirestore.instance.collection('ChiChuyenKhoan');
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      DropdownButtonFormField(
                                        ...
                                        dropdownColor: const Color.fromARGB(
                                            255, 255, 255, 255),
                                        value: dropdownTaiKhoanChi,
                                        onChanged: (String? value) {
                                          setState(() {
                                            dropdownTaiKhoanChi = value!;
                                          });
                                        },
                                        items: listTaiKhoanChi
                                            .map<DropdownMenuItem<String>>(
                                                (String value) {
                                          return DropdownMenuItem<String>(
                                            value: value,
